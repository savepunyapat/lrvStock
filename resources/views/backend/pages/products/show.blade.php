            ...
            <div class="row mb-5">
                <div class="col-md-3 mx-4 mt-3">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6">{{ $product->product_status }}</div>
                    </div>
                    <div class="row mt-2">
                ...
                <div class="col-md-8 mx-4 mt-3">
                    ...
                    <div class="col-md-12"><pre style="font-family: Kanit, sans-serif; padding-left:0px">{!! config('global.global_var.pro_status')[$product->product_status]  !!}</pre></div>
                    </div>
                </div>
        </div>
    </div>
